      ...
      <div className="pt-3 dark:text-white">
        ...
        <div className="flex flex-wrap space-between">
          ...
          <div className=" w-[250px] my-3  rounded-lg h-48">
            ...
            <div onClick={() => { window.print() }} className="bg-white dark:bg-gray-800 flex cursor-pointer my-4 drop-shadow-md hover:scale-110 rounded-lg w-[250px] p-2 h-10"><BsCloudDownload className='text-2xl mx-5' />Download</div>
